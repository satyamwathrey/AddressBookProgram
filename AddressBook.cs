...
namespace AddressBookProgram
{
    class AddressBook : IContact
    {
        ...
        List<Contact> IContact.AddNewContact()
        {
        ...
        void IContact.EditContact(string input)
        {
            throw new NotImplementedException();
        }

        void IContact.DeleteContact(string fName, string lName)
        {
            throw new NotImplementedException();
        }

        void IContact.AddNewAddressBook()
        {
            throw new NotImplementedException();
        }
    }
